	  ...
	  <script type="text/javascript">
		  $(function(){
			  $("#next").click(function(){
				  ...
				  page++;
				  location.href = "/user/reading?page="+page;
			  })
			  ...
			  $("#first").click(function () {
				  location.href = "/user/reading?page=1";
			  })

			  $("#last").click(function(){
				  var pages = parseInt($("#pages").html());
				  location.href = "/user/reading?page="+pages;
			  })
		  })
	  </script>
  </head>
...
<%--					<td></td>--%>
					...
					<td>
						<a href="/update/restore?bookId=${resultList.bookId}&borrowId=${resultList.borrowId}">归还</a>
					</td>
<%--					<td>--%>
